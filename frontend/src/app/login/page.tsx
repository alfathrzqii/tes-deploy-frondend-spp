          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-950 border border-slate-800 text-white pl-10 pr-4 py-2.5 rounded-lg text-sm placeholder:text-slate-600 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all"
                disabled={loading}
              />
            </div>
          </div>
      ...
      <div className="mt-4 text-center">
        ...
        <div className="mt-8 border-t border-slate-800/80 pt-6 text-[11px] text-slate-500">
          ...
          <ul className="list-disc pl-4 space-y-0.5">
            <li>Super Admin: <span className="text-slate-300">superadmin@sekolah.sch.id</span> (password: <span className="text-slate-300">admin123</span>)</li>
            <li>Admin SD: <span className="text-slate-300">adminsd@sekolah.sch.id</span> (password: <span className="text-slate-300">admin123</span>)</li>
            <li>Wali Murid: <span className="text-slate-300">parent@test.com</span> (password: <span className="text-slate-300">parent123</span>)</li>
          </ul>
        </div>
      </div>
    </div>
